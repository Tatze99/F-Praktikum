...
\begin{figure}[htp]
    \centering
        \includegraphics[height=0.9\textwidth]{Bilder/Saettigung_inhomogen.pdf}
...
\begin{figure}[htp]
    \centering
        \includegraphics[height=0.9\textwidth]{Bilder/HeNe-Termschema.pdf}
...
\begin{figure}[htp]
    \centering
        \includegraphics[height=0.9\textwidth]{Bilder/HeNe-Laser_Aufbau.pdf}
