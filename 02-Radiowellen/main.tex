...
\end{align}
Bei der Verwendung von Sinussignalen bilden sich stehende Wellen durch Interferenz von hinlaufender und refelektierter Welle aus. Alternativ zum Reflexionsfaktor wird das Stehwellenverhältnis \text{VSWR} (voltage standing wave ratio) definiert
\begin{align}
...
Diese Modulationsvariante wird in der Praxis häufiger eingesetzt und kann mit Diodenringmodulatoren realisiert werden. Dabei werden die beiden Schwingungen direkt miteinander multipliziert~\cite{Forker}
\begin{align}
