\begin{figure}[htp]
  ...
  \begin{tikzpicture}
    \begin{axis}[disabledatascaling, width=.95\textwidth, height=6cm, ylabel=Temperatur $T$ in \si{\kelvin}, xmin=0, xmax=300, ymin=50, xlabel={Zeit $t$ in \si{\second}}, legend cell align={left}]
      ...
      \addplot[blue, thick] table[x index=0,y index=1]{Daten/Kalibrierung_Pt100_abkuehlung_Widerstand.txt};
      \addlegendentry{ohne Isolierung}
      \addplot[orange, thick] table[x index=0,y index=1]{Daten/Kalibrierung_Pt100_Isolierung_Widerstand.txt};
