...
Im Rahmen des Versuchs werden nur die Kubischen Gitter relevant sein, woraus folgt, dass nur eine Gitterkonstante ermittelt werden muss.
\begin{align}
  a_0 = b_0 = c_0 =: a_0
\end{align}
