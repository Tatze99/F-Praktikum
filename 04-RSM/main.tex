...
%Zusammengefasst ergeben sich folgende, aus %den oben beschriebenen Überlegungen %bestimmten,  Gitterkonstanten:
%würde ich gern so schreiben, aber nur, wenn die Tabelle dann gleich danach kommt.
...
Bei der Aufnahme mit dem Rastertunnelmikroskop sind mehrere Abbildungsfehler möglich, von denen einige bereits in den vorhergehenden Abschnitten diskutiert werden. An dieser Stelle sollen diese nocheinmal zusammenfassend dargestellt werden.
...
Deformationen der Spitze können sich auch in einem zackigen Höhenprofil der eigentlich runden Goldtröpfchen äußern. Zur Behebung des Problems werden die gleichen Maßnahme wie bei einer Doppelspitze ergriffen.
