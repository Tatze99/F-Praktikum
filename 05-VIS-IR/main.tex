...
\begin{figure}[htp ]
  \centering
  \begin{tikzpicture}
    \begin{axis}[width=0.98\textwidth, height=8cm, samples=300, xmin=0.5, xmax=10, ymin=0, ymax=55000, xlabel={Wellenlänge $\lambda$ in \si{\micro\metre}}, ylabel={Energiedichte $u(\lambda,T)$ in \si{\watt\per\metre\per\micro\metre}}]
...
\input{Bilder/Eichung_SPM1_mitQuecksilberdapflampe.tex}
...
\input{Bilder/AbsorptionSiO2.tex}
...
\input{Bilder/AbsorptionsrateSiO2.tex}
\FloatBarrier
...
\input{Bilder/ReflektivitätSiO2.tex}
