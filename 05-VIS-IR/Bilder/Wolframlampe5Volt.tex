\begin{figure}[htp]
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
  \caption{Transmissionsspektren von Silizium und Galiumarsenid im Vergleich zu einer Referenzmessung. Es muss jedoch beachtet werden, dass zur Aufnahme der Transmissionsspektren von Si und Ge eine höhere Verstärkung im Lock-In verwendet wurde, was einen quantitativen Vergleich der Kurven erschwert.}
